  ...
  const showPrivacy = () => setModalContent({
    ...
    content: (
      <div className="space-y-4">
        <p>Welcome to Visit Saudi. Your privacy is paramount. This policy details how we collect and protect your data.</p>
        <h4 className="font-bold">1. Information Collection</h4>
        <p>Interaction data may be collected when you use our AI planner or contact form. We never sell your personal data.</p>
        <h4 className="font-bold">2. Cookies</h4>
        <p>We use cookies to optimize user experience. Partners may also use cookies for personalized advertising.</p>
        <h4 className="font-bold">3. Security</h4>
        <p>We use industry-standard encryption to ensure your information is safe from unauthorized access.</p>
      </div>
    )
  });
  ...
  const showTerms = () => setModalContent({
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>All travel guides and media are for personal use only. Commercial reproduction is prohibited.</p>
        <h4 className="font-bold">2. Disclaimer</h4>
        <p>Information provided is for reference. Travel regulations can change. Always verify visa requirements before travel.</p>
      </div>
    )
  });
      ...
      <div className="min-h-screen">
        ...
        <footer className="bg-stone-950 text-white py-12">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-stone-600 text-xs">© {new Date().getFullYear()} Visit Saudi. All Rights Reserved.</p>
          </div>
        </footer>
      </div>
    );
        ...
        <section id="about" className="py-24 bg-white">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-4xl font-serif mb-8">About Visit Saudi</h2>
              <p className="text-stone-600 leading-relaxed mb-6">
                Visit Saudi is an independent portal dedicated to showcasing the profound beauty and rapid evolution of the Kingdom of Saudi Arabia to the global community.
              </p>
              <p className="text-stone-600 leading-relaxed">
                Our mission is to bridge the information gap using advanced AI technology and authentic local insights. From heritage sites to modern skylines, we are your premier digital gateway.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12">
              <div className="max-w-xl">
                ...
                <p className="text-stone-500">Carefully curated guides to Saudi Arabia's most iconic locations. Click to view detailed planning advice.</p>
              </div>
            </div>
            ...
            <div className="container mx-auto px-6 max-w-2xl">
                <div className="bg-white rounded-3xl p-10 shadow-xl">
                    ...
                    <p className="text-stone-500 text-center mb-10 text-sm">
                        Planning a bespoke trip or have media inquiries? Our team is here to assist.
                    </p>
      ...
      <footer className="bg-stone-950 text-white py-16">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              ...
              <p className="text-stone-500 text-sm leading-relaxed">
                Your premier gateway to exploring the Kingdom of Saudi Arabia. Discover the unknown.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-3 text-stone-400 text-sm">
                ...
                <li><a href="#ai" className="hover:text-white">AI Planning</a></li>
          ...
          <div className="border-t border-stone-800 pt-10 text-center">
            <p className="text-stone-600 text-xs">© {new Date().getFullYear()} Visit Saudi Portal. Independent Travel Guide.</p>
          </div>
        </div>
      </footer>
    </div>
